...
export const Itinerary = ({ trip }) => {
  // Image error handler to replace with placeholder
  const handleImageError = (e) => {
    e.target.onerror = null; // Prevent infinite callbacks if placeholder also fails
    e.target.src = "/placeholder-travel.png"; // Replace with your placeholder image path
  };
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-3 md:gap-6 xl:gap-5">
                {day.Activities?.map((activity, activityIndex) => (
                  ...
                  >
                    ...
                    >
                      <img
                        src={activity.PlaceImageURL || "/default.jpg"}
                      ...
                      <p className="my-1">
                        <span className="font-bold">Ticket Pricing:</span>{" "}
